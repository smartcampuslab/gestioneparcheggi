...
pm.service('gMapService', ['$rootScope', '$dialogs', '$timeout', 'sharedDataService',
    ...
    this.updateLoadingMapState = function () {
      ...
      $rootScope.$broadcast('dialogs.wait.progress', {
        msg: this.getLoadingText(),
        'progress': this.progress,
        m_title: this.getLoadingTitle()
      });
    };
    ...
    this.getActualPmProfit = function (pmId) {
      ...
      var found = false;
      for (var i = 0;
        ((i < this.profitParkingMeterWS.length) && (!found)); i++) {
      ...
      for (var i = 0; i < markers.length; i++) {
        ...
        if (myMarker != null && myMarker.options != null) {
          ...
          case 0:
            ...
            if (myMarker.data.paymentMethods.indexOf("Cash_And_CreditCard") > -1) {
              myMarker.icon = baseUrl + '/marker/' + company + '/parcometrocarta/' + ((myAreaPm != null) && (myAreaPm.color != null) ? myAreaPm.color : defaultMarkerColor);
            } else {
              myMarker.icon = baseUrl + '/marker/' + company + '/parcometro/' + ((myAreaPm != null) && (myAreaPm.color != null) ? myAreaPm.color : defaultMarkerColor);
            }
            break;
          case 1:
    ...
    this.initStreetObject = function (street, type) {
      ...
      if (type == 0) {
        ...
        //street.data.paidSlot = streetPaidSlot;
    ...
    this.createMarkers = function (i, marker, type) {
      ...
      case 1:
        ...
        if (marker.paymentMethods.indexOf("Cash_And_CreditCard") > -1) {
          myIcon = baseUrl + '/marker/' + company + '/parcometrocarta/' + ((myAreaPm != null) && (myAreaPm.color != null) ? myAreaPm.color : defaultMarkerColor);
        } else {
