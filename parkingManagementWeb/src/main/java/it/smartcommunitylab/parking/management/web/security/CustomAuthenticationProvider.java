...
//		}
		ProviderSetting app = appSetup.findProviderById(username);
		if (app == null) {
	...
	public class AppDetails implements UserDetails {
		...
		private ProviderSetting app;
		
		public AppDetails() {
			super();
		}

		public AppDetails(ProviderSetting app) {
			super();
			this.app = app;
		}
		...
		public ProviderSetting getApp() {
			return app;
		}

		public void setApp(ProviderSetting app) {
			this.app = app;
		}
	}
