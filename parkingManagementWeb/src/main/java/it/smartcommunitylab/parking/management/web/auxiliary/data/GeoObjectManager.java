...
//		}
	...
	// Method used to cast structure occupancy data from string to object (list of PSOccupancyData)
	...
	// Method used to cast street occupancy data from string to object (list of SOccupancyData)
